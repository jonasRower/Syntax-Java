    ...
    public static void main(String[] args) {
        ...
        but1.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                ...
                TiskniPromennou Data = new TiskniPromennou();	
                text = Data.VratPromennou();

                text = text + "\n\nPromenna je definovana v tride definujPromennou";
                text = text + "\nPromenna je tisknuta z tridy TiskniPromennou";
        ...
        but2.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                ...
                text = text + "\n\nPole je definovano v tride definujPole";
                text = text + "\nPole je tisknuto z tridy TiskniPole";

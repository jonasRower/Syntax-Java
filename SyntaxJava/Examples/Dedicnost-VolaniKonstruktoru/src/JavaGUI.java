    ...
    public static void main(String[] args) {
        ...
        but2.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                ...
                A a = new A();	//objekt typu rA
                B b = new B();	//objekt typu rB
                C c = new C();	//objekt typu rC

                A r;				//vytvoreni odkazu na typ rA

                r = a;				//r se odkazuje na objekt typu rA;
                r.callme();			//volani metody callme tridy rA

    ...
    public static void main(String[] args) {
        ...
        but1.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                ...
                text = "Hodnota pred volanim: " + a + "   " + b;

                Trida.meth(a, b);
                text = text + "\n      Hodnota po volani: " + a + "   " + b;
        ...
        but2.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                ...
                novaTrida2 Trida2 = new novaTrida2(15, 10);

                String text;
                text = "Hodnota pred volanim: " + Trida2.a + "   " + Trida2.b;

                Trida2.meth(Trida2);
                text = text + "\n      Hodnota po volani: " + Trida2.a + "   " + Trida2.b;

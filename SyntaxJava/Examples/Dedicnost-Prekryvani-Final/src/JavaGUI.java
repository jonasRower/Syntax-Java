    ...
    public static void main(String[] args) {
        ...
        but2.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                ...
                text = text + "\n\nVysledky se zobrazuji, protoze\n";
                text = text + "metoda 'show()' je zakomentovana\n";
                text = text + "pokud se odkomentuje, kod nejde spustit\n";
                text = text + "protoze metoda 'show()' je final ve tride A2\n";

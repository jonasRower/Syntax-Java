    ...
    public static void main(String[] args) {
        ...
        but1.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                ...
                novaTrida trida1 = new novaTrida(10);
                novaTrida trida2 = new novaTrida(20);

                String text;

                //zde vraci promennou z trida1 
                text = "" + trida1.VratPromennou1(trida2);
                t1.setText(text);  
            }
        });
        ...
        but2.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                ...
                //zde vraci promennou z konstruktoru trida2 
                text = "" + trida1.VratPromennou2(trida2);
                t2.setText(text);  
            }
        });

    ...
    public static void main(String[] args) {
        ...
        but1.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                ...
                GenMethDemo Gen = new GenMethDemo();
                Text = Gen.VratText();
        ...
        but2.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                ...
                GenMethDemo<Integer> iOb;
                iOb = new GenMethDemo<Integer>(88);

                GenMethDemo<String> strOb = new GenMethDemo<String> ("test prace s generickou tridou");
                text = iOb.showType() + "\n";
